...
const Events = () => {
  return (
    <div> 
        <div className="md:p-12 md:mt- md:text-[36px]  mx-auto text-center max-w-screen-2xl text-logoBlue bg-graydark ">
           KEEP UP TO DATE WITH THE LATEST NEWS AND BLOG POSTS
                  </div>
      <section class="text-black body-font  items-center">
     
  <div class="   px-5  p-10 mx-auto flex flex-wrap  bg-graydark  ">
    <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
    <section class="text-gray-600 body-font">
  <div class="container px-5 py-15 mx-auto items">
      <h2 className="text-center text-[32px] py-5 text-logoBlue"> UPCOMING EVENTS</h2>
    ...
    <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center flex items-center">
    <h2 className="text-center text-[32px]  text-center text-logoBlue"> RECENT POSTS</h2>
    <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
      <div class="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full   text-indigo-500 flex-shrink-0">
        <Image className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center  rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0 "src = {passport} alt="/" width="500" height="50" priority={true} />
      </div>
      <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
        <h2 class="text-gray-900 text-xl title-font font-medium mb-2  "> Second Random Selection from Previously Submitted Registrations Complete for FY 2024 H-1B Cap</h2>
    ...
    <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
      <div class="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full   text-indigo-500 flex-shrink-0">
        <Image className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center  rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0 "src = {immigration} alt="/" width="500" height="50" priority={true} />
      </div>
      <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
        <h2 class="text-gray-900 text-xl title-font font-medium mb-2  "> Second Random Selection from Previously Submitted Registrations Complete for FY 2024 H-1B Cap</h2>
    ...
    <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
      <div class="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full   text-indigo-500 flex-shrink-0">
        <Image className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full  bg-indigo-100 text-indigo-500 flex-shrink-0 "src = {law} alt="/" width="500" height="50" priority={true} />
      </div>
      <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
        <h2 class="text-gray-900 text-xl title-font font-medium mb-2  "> Second Random Selection from Previously Submitted Registrations Complete for FY 2024 H-1B Cap</h2>
